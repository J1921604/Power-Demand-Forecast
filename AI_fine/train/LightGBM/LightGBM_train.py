...
def create_prediction_plots(y_pred: np.ndarray,
    ...
    plt.title('LightGBM 電力需要予測結果 (全期間)', fontsize=config.TITLE_FONTSIZE)
    ...
    plt.xlabel('Time', fontsize=config.LABEL_FONTSIZE)
    plt.ylabel('Power [kW]', fontsize=config.LABEL_FONTSIZE)
    plt.title('LightGBM 電力需要予測結果 (1週間)', fontsize=config.TITLE_FONTSIZE)
    plt.legend(fontsize=config.LEGEND_FONTSIZE)
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
...
def main() -> None:
    ...
    try:
        ...
        model_sav = r'C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\train\LightGBM\LightGBM_model.sav'
        ypred_csv = r'C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\train\LightGBM\LightGBM_Ypred.csv'
        ypred_png = r'C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\train\LightGBM\LightGBM_Ypred.png'
        ypred_7d_png = r'C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\train\LightGBM\LightGBM_Ypred_7d.png'
        
        # ハイパーパラメータ設定（LightGBMでは使用されないが互換性のため）
        learning_rate_param = config.DEFAULT_LEARNING_RATE
        epochs = ''
        validation_split = ''
        history_png = r'C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\train\LightGBM\LightGBM_history.png'
