...
def main() -> None:
    ...
    model_sav = r'C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\train\Pycaret\Pycaret_model'
    ypred_csv = r'C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\train\Pycaret\Pycaret_Ypred.csv'
    ypred_png = r'C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\train\Pycaret\Pycaret_Ypred.png'
    ypred_7d_png = r'C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\train\Pycaret\Pycaret_Ypred_7d.png'
    
    # ハイパーパラメータ設定（PyCaretでは使用されないが互換性のため）
    learning_rate = ''
    epochs = ''
    validation_split = ''
    history_png = r'C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\train\Pycaret\Pycaret_history.png'
    ...
    try:
        ...
        if result:
            rmse, r2 = result
            print("="*60)
            print(f"🎯 PyCaret学習完了 - RMSE: {rmse:.2f}, R2スコア: {r2:.3f}")
            print("="*60)
        else:
            print("❌ 学習処理が失敗しました")
