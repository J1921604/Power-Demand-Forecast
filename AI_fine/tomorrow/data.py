...
def generate_target_path(year: int) -> str:
    ...
    Returns:
        str: 生成されたファイルパス
    """
    return rf"C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\data\juyo-{year}.csv"
...
def main() -> None:
    ...
    try:
        ...
        # ファイルパス設定
        Ytest_csv = r"C:\Users\Z9995695\Documents\UiPath\Python連携AI電力需要予測モデル_v2\AI\tomorrow\Ytest.csv"
        past_days = '7'
        forecast_days = '7'
